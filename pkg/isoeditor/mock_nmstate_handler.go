...
func (m *MockNmstateHandler) ExtractNmstatectl(arg0 string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockNmstateHandlerMockRecorder) ExtractNmstatectl(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExtractNmstatectl", reflect.TypeOf((*MockNmstateHandler)(nil).ExtractNmstatectl), arg0)
}
